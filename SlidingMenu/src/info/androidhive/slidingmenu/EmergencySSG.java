...
public class EmergencySSG extends Activity
{
	static final LatLng Defloc = new LatLng(22.307502, 73.190041);
	private GoogleMap googleMap;
	
	protected void onCreate(Bundle savedInstanceState)
	 {
		 super.onCreate(savedInstanceState);
		 setContentView(R.layout.emergency_ssg);
		 
		 Button startBtn = (Button) findViewById(R.id.btn_call_ssg);
	      ...
	      try 
			{
				...
				CameraPosition cameraPosition = new CameraPosition.Builder().target(
		                new LatLng(22.307502, 73.190041)).zoom(12).build();
	...
	protected void makeCall()
	{
	      ...
	      {
	         Toast.makeText(EmergencySSG.this, 
